...
public class Tutee extends User {
    ...
    public Tutee(String student_id, String student_name, String student_email, String password, Role role, int year_of_study, String expertise, int max_hours_per_week) {
